...
<jsp:include page="/menu/top.jsp" flush='false' /> 
 <DIV class='title_box'>개발일지 수정 Test v0.1</DIV>
 ...
 <!--  임시값    
  <input type='hidden' name='employeeno' id='employeeno' value='1'>
      ...
      <div class="form-group">   
        ...
        <div class="col-md-2">
          <select class="form-control" style='width: 70%; font-size: 14px; height: 34px;' name='field' id='field'>
            <c:choose>
              <c:when test="${journalVO.field eq '개발'}">
                <option selected="selected">개발</option>
                <option>설계</option>
                <option>디자인</option>
                <option>보안</option>
              </c:when>
              <c:when test="${journalVO.field eq '설계'}">
                <option>개발</option>
                <option selected="selected">설계</option>
                <option>디자인</option>
                <option>보안</option>
              </c:when>
              <c:when test="${journalVO.field eq '디자인'}">
                <option>개발</option>
                <option>설계</option>
                <option selected="selected">디자인</option>
                <option>보안</option>
              </c:when>
              <c:when test="${journalVO.field eq '보안'}">
                <option>개발</option>
                <option>설계</option>
                <option>디자인</option>
                <option selected="selected">보안</option>
              </c:when>
            </c:choose>
           </select>
        </div> 
      ...
      <div class="form-group">   
        ...
        <div class="col-md-8">
          <input type='text' class="form-control input" name='title' id='title' value='${journalVO.title}' required="required" style='width: 80%; font-size: 13px; '>
        </div>
        <label for="title" class="col-md-2 control-label"></label>
      </div>   
      
      <c:forEach var="item_list" items="${item_list}" varStatus="status">
        ${item_list}
        ${itemState_list[status.index]}
      </c:forEach>
      ...
      <div class="form-group" id="group1">   
        ...
        <div class="col-md-2">
          <select class="form-control" style='width: 70%; font-size: 14px; height: 34px;' name='items_state1' id='items_state1' >
            <option>진행예정</option>
            <option>진행중</option>
            <option>진행완료</option>
           </select>
      ...
      <div class="form-group" id="group2">   
        ...
        <div class="col-md-2">
          <select class="form-control" style='width: 70%; font-size: 14px; height: 34px;' name='items_state2' id='items_state2' >
            <option>진행예정</option>
            <option>진행중</option>
            <option>진행완료</option>
           </select>
      ...
      <div class="form-group" id="group3">   
        ...
        <div class="col-md-2">
          <select class="form-control" style='width: 70%; font-size: 14px; height: 34px;' name='items_state3' id='items_state3' >
            <option>진행예정</option>
            <option>진행중</option>
            <option>진행완료</option>
           </select>
      ...
      <div class="form-group" id="group4">   
        ...
        <div class="col-md-2">
          <select class="form-control" style='width: 70%; font-size: 14px; height: 34px;' name='items_state4' id='items_state4' >
            <option>진행예정</option>
            <option>진행중</option>
            <option>진행완료</option>
           </select>
      ...
      <div class="form-group" id="group5">   
        ...
        <div class="col-md-2">
          <select class="form-control" style='width: 70%; font-size: 14px; height: 34px;' name='items_state5' id='items_state5' >
            <option>진행예정</option>
            <option>진행중</option>
            <option>진행완료</option>
           </select>
      ...
      <div class="form-group" id="group6">   
        ...
        <div class="col-md-2">
          <select class="form-control" style='width: 70%; font-size: 14px; height: 34px;' name='items_state6' id='items_state6' >
            <option>진행예정</option>
            <option>진행중</option>
            <option>진행완료</option>
           </select>
...
<!--        
      ...
      <div class="form-group">   
        ...
        <div class="col-md-1">
          <input type='number' min="1" step="1" class="form-control input" name='seqno' id='seqno' value='${journalVO.seqno}' required="required" style='width: 80%; font-size: 14px;'>
        </div>
        <label for="title" class="col-md-9 control-label"></label>
      </div>   
      ...
      <div class="form-group">   
        ...
        <div class="col-md-2">
          <input type='text' class="form-control input" name='rname' id='rname' value='${journalVO.employee_name}' required="required" style='width: 100%; font-size: 14px;'>
        </div>
        <label for="title" class="col-md-8 control-label"></label>
      </div>   
      ...
      <div class="form-group">   
        ...
        <div class="col-md-2">
          <input type='text' class="form-control input" name='rname' id='rname' value='${journalVO.rname}' required="required" style='width: 100%; font-size: 14px;'>
        </div>
        <label for="title" class="col-md-8 control-label"></label>
      </div>     
