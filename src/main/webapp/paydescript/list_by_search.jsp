...
<form name='frm2' id='frm2' method="GET" action="./list_by_search_paging.do"> 
<input type="hidden" name="nowPage" id="nowPage" value='1'> 
 ...
 <DIV class='title_box'>급여 명세서 목록 Test v0.1</DIV>
  ...
  <ASIDE style='float: right;'>
    ...
    <button type='button' 
                 onclick="location.href='./list_by_search.do'">전체 보기</button>
    ...
    <A href='./list_by_search.do'>급여명세서</A>
    <span style='font-size: 1.2em;'>></span>
    <A href='./list_by_search.do'>목록</A>
    <c:if test="${param.word.length() > 0}"> 
    <span style='font-size: 1.2em;'>></span> 
    <A href='./list_by_search.do'>검색</A>
    <span style='font-size: 1.2em;'>></span>       
