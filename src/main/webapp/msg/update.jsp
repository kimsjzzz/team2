...
<FORM name='frm' method='POST' action='./update.do'>
    <input type='hidden' name='msgno' id='msgno' value='${msgVO.msgno }'>
    <input type='hidden' name='sender' id='sender' value='${msgVO.sender }'>
    받는 사람 : 
    ...
    <div class="form-group">   
      ...
      <div class="col-md-11">
        <textarea class="form-control input-lg" name='content' id='content'  rows='10'>${msgVO.content }</textarea>
      </div>
    </div>
